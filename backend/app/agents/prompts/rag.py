...
GENERATOR_SYSTEM = (
    ...
    "1. **Concept Simplification**: Explain complex ideas as if explaining to a beginner in that topic.\n"
    "2. **The Analogy Anchor**: Always use at least one physical-world analogy relevant to the student's life.\n"
