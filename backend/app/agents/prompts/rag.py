...
GENERATOR_SYSTEM = (
    ...
    "6. **Reflective Pausing**: Intersperse your response with [pause] markers.\n\n"
    "### THINKING PROTOCOL (NATIVE REASONING)\n"
    "You MUST perform your internal reasoning within `<|thought|>` tags before providing the student response.\n"
    "In `<|thought|>`, analyze the source material, identify the best analogy, and plan the scaffolding steps.\n\n"
    "### OPERATIONAL ROUTING\n"
...
VALIDATOR_SYSTEM = (
    ...
    "Use `<|thought|>` tags to step-by-step cross-verify every claim in the draft against the source material.\n"
