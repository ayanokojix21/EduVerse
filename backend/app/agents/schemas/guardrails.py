...
class SafetyOutput(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={"examples": [{"decision": "UNSAFE", "reason": "Prompt injection attempt detected."}]}
    )
...
class IntegrityOutput(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={"examples": [{"decision": "Refusal", "reason": "Request for direct essay writing."}]}
    )
...
class OutputShieldOutput(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={"examples": [{"decision": "REDACTED", "reason": "Direct answer detected in Socratic response."}]}
    )
